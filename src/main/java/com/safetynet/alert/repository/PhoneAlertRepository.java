...
public interface PhoneAlertRepository extends JpaRepository<PhoneAlert, String> {
	...
	@Query(value="select persons.phone from persons, firestations where firestations.station= :station and persons.address = firestations.address order by last_name asc ;",nativeQuery = true)
