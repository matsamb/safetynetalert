...
public class FirestationsDaoLoaderServiceTest {
	...
	@Test
	public void givenAjsonString_WhenStringToDaoIsCalled_ThenSaveAllFirestationsShouldBeUsedOnce() {

		verify(firestationsDAO, times(1)).saveAllFirestations(anyList());
