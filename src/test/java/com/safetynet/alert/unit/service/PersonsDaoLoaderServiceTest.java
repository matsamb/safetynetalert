...
public class PersonsDaoLoaderServiceTest {
	...
	@Test
	public void givenAjsonString_WhenStringToDaoIsCalled_ThenSaveAllPersonsShouldBeUsedOnce() {
				
		verify(personDAO, times(1)).saveAllPersons(anyList());
